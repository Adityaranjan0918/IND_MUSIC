...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("The_ind_coders")
              
                await self.one.join_chat("the_ind_coder")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("he_ind_coder")
                
                await self.one.join_chat("he_ind_coder")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("he_ind_coders")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("he_ind_coders")
